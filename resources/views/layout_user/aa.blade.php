...
<html lang="en">
  ...
  <head>
    ...
    <title>GoKid - Penetuan Desa Wisata Terfavorit Gunung Kidul</title>
...
-->
    ...
    <link rel="stylesheet" href="{{ asset('user/assets/css/templatemo-chain-app-dev.css') }}">
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <a href="index.html" class="logo" style="text-decoration: none;">
                        <span style="font-size: 2rem; font-weight: bold; color: #ff6b6b; letter-spacing: 1px;">GO</span>
                        <span style="font-size: 2rem; font-weight: bold; color: #4caf50; letter-spacing: 1px;">KID</span>
                    </a>
                    <!-- ***** Logo End ***** -->
            ...
            <ul class="nav">
              ...
              <li class="scroll-to-section"><a href="/desa-wisata">Desa Wisata</a></li>
              <li class="scroll-to-section"><a href="/maut">Penentuan</a></li>
              <li class="scroll-to-section"><a href="petunjuk">Petunjuk</a></li>
      ...
      <div class="row">
        ...
        <div class="col-lg-3">
          <div class="footer-widget">
            ...
            <div class="logo">
              <img src="{{asset('user/assets/images/white-logo.png')}}" alt="">
            </div>
